...
Public Class EmployeesSchema
	...
	Public Shared EmployeeID As New SchemaItem("EmployeeID", DbType.Guid, False, False, False, True, False, True)
	...
	Public Shared ReportsTo As New SchemaItem("ReportsTo", DbType.Int32, False, True, False, False, False, False)
...
Public MustInherit Class _Employees
	...
	Public Function LoadByPrimaryKey(ByVal EmployeeID As Guid) As Boolean
...
#Region " Properties "
	...
	Public Overridable Property EmployeeID() As Guid
        Get
			Return Me.GetGuid(EmployeesSchema.EmployeeID.FieldName)
      End Get
        Set(ByVal Value As Guid)
			Me.SetGuid(EmployeesSchema.EmployeeID.FieldName, Value)
      End Set
    End Property
		...
		Public Overridable Property s_EmployeeID As String
			Get
				If Me.IsColumnNull(EmployeesSchema.EmployeeID.FieldName) Then
					Return String.Empty
				Else
					Return MyBase.GetGuidAsString(EmployeesSchema.EmployeeID.FieldName)
				End If
			End Get
			Set(ByVal Value As String)
				...
				Else
					Me.EmployeeID = MyBase.SetGuidAsString(EmployeesSchema.EmployeeID.FieldName, Value)
				End If
			End Set
		End Property
